...
const saveResult = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield result_service_1.ResultService.saveResult(req);
